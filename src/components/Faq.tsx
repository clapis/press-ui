...
export default function Faq() {
    return (
      <div className="w-full px-3">
        <p className="text-lg text-center font-semibold mb-6">Perguntas Frequentes</p>
        <Accordion type="single" collapsible>
          <AccordionItem value="1">
            <AccordionTrigger>O serviço é gratuito?</AccordionTrigger>
            <AccordionContent>
              Sim, o serviço de alerta é totalmente gratuito. No futuro,
              ofereceremos o plano Plus, que inclui funcionalidades
              extras, como número ilimitado de alertas e outras vantagens
              exclusivas.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="2">
            ...
            <AccordionContent>
              ...
              <p>Estamos constantemente expandindo nossa cobertura com base no interesse dos usuários.</p>
            </AccordionContent>
          </AccordionItem>
